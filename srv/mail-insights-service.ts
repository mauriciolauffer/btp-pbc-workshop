...
export default class MailInsights extends cds.ApplicationService {
     ...
     * @return {Promise<Array<[string]>>} - Returns a Promise that resolves to an array of closest responses.
     */
     ...
     * @return {Promise<Array<[MailWithSimilarity]>>} - Returns a Promise that resolves to an array of closest mails.
     */
